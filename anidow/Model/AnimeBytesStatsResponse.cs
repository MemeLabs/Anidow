...
namespace Anidow.Model
{
    public class Api
    {
        ...
        public int Compat { get; set; }
    }

    public class Freeleech
    {
        [JsonPropertyName("sitewide")]
        public int Sitewide { get; set; }
    ...
    public class Torrents
    {
        ...
        [JsonPropertyName("ssize")]
        public long Ssize { get; set; }

        [JsonPropertyName("sttime")]
        public long Sttime { get; set; }

        [JsonPropertyName("satime")]
    ...
    {
        [JsonPropertyName("Aka-chan")]
        public int AkaChan { get; set; }

        [JsonPropertyName("User")]
        public int User { get; set; }

        [JsonPropertyName("Power User")]
        public int PowerUser { get; set; }

        [JsonPropertyName("Elite")]
        public int Elite { get; set; }

        [JsonPropertyName("Torrent Master")]
        public int TorrentMaster { get; set; }
        ...
        [JsonPropertyName("Sensei")]
        public int Sensei { get; set; }
    }
    ...
    public class ABSite
    {
        ...
        [JsonPropertyName("peers_uniq")]
        public PeersUniq PeersUniq { get; set; }
    ...
    {
        [JsonPropertyName("yen")]
        public Yen Yen { get; set; }

        [JsonPropertyName("hnrs")]
        public Hnrs Hnrs { get; set; }
    ...
    public class AnimeBytesStatsResponse
    {
        ...
        public Freeleech Freeleech { get; set; }
