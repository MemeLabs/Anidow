...
namespace Anidow.Migrations
{
    ...
    [Migration("20210825082504_NotifyMustMatch")]
    partial class NotifyMustMatch
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Anidow.Database.Models.AppState", b =>
                {
                    ...
                    b.Property<DateTime>("Created")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
                        .HasDefaultValue(new DateTime(2021, 8, 25, 8, 25, 3, 922, DateTimeKind.Utc).AddTicks(9033));
            ...
            modelBuilder.Entity("Anidow.Pages.NotifyItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Anidow.Pages.NotifyItemKeyword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Anidow.Pages.NotifyItemMatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Anidow.Pages.NotifyItemKeyword", b =>
                {
                    b.HasOne("Anidow.Pages.NotifyItem", "NotifyItem")
                        .WithMany("Keywords")
